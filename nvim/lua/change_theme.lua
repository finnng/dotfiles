...
function _G.open_theme_selector()
    ...
    local opts = {
        ...
        style = 'minimal',
        border = 'rounded',
        noautocmd = true,  -- Avoid triggering autocommands that could interact with the window
    }
    ...
    local mappings = {
        ['j'] = 'MoveCursor(1)',
        ['k'] = 'MoveCursor(-1)',
        ['<CR>'] = 'SetThemeAndClose()',  -- Enter key to set the theme and close
        ['<Esc>'] = 'CloseWindow()',
    }
    ...
    -- Function to change the theme when the cursor moves
    ...
    -- Function to set the chosen theme and close the window
    _G.SetThemeAndClose = function()
